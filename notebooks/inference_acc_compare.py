...
from transformers import GenerationConfig, LogitsProcessorList, InfNanRemoveLogitsProcessor
import json
...
def chat_loop(model, data_dir, save_dir, tokenizer, template_name, device,
    ...
    with open(os.path.join(save_dir, "ret_all.json"), "w", encoding="utf-8") as f3:
...
if __name__ == "__main__":
    ...
    main(eval_data=dataset_path, save_dir=eval_result_dir, model=original_model,
         device=original_model.device,model_type="original")
